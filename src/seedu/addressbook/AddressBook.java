...
public class AddressBook {
    ...
    private static final String COMMAND_LIST_ALPHA = "sortAlpha";
     ...
     */
    private static final ArrayList<String[]>ALL_PERSONS_ALPHA = new ArrayList<>();
    /**
    ...
    private static String executeCommand(String userInputString) {
        ...
        switch (commandType) {
            ...
            case COMMAND_LIST_ALPHA:
                return executeListAllInAlpha();
    ...
    /**
     * Display all persons in the address book in alphabetical order;
     */
    ...
    private static void sortListAlpha(ArrayList<String[]> list, int comparisonValue) {
        ...
        for(int i=START_INDEX; i<list.size()-1;i++) {
            for(int j=START_INDEX; j<list.size()-i-1; j++) {
                ...
                swapPersonListPosition(list, comparisonValue, myCollator, j, person, person2);
            }
        }
    }
    /**
     ...
     */
    private static void makePersonFromData(String name, String phone, String email,HashMap<PersonProperty,String> person) {
    ...
    private static Optional<String[]> decodePersonFromString(String encoded) {
        ...
        makePersonFromData(
                extractNameFromPersonString(encoded),
                extractPhoneFromPersonString(encoded),
                extractEmailFromPersonString(encoded),decodedPerson
        );
        String[] details = new String[3];
